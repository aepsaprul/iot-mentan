@extends('layouts.app')
@section('title') Ubah Pengepul @endsection
@section('style')
@endsection
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form action="{{ route('pengepul.update', [$pengepul->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group row">
                  <label for="nama" class="col-sm-2 col-form-label">Nama Pengepul</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ $pengepul->nama }}" placeholder="Nama Pengepul">
                    @error('nama')
