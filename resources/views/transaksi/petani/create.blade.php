                ...
                <div class="row mb-3">
                  @if (auth()->user()->hasRole('adm'))
                    <div class="col-lg-4 col-12 mb-3">
                      <label for="pengguna_id">Nama Petani</label>
                  ...
                  @else
                    {{-- petani id --}}
                    <input type="hidden" name="pengguna_id" id="pengguna_id" value="{{ $petani->id }}">

                    <div class="col-lg-4 col-12 mb-3">
                      <label>Nama Petani</label>
                      <input type="text" class="form-control" value="{{ $petani->nama }}" placeholder="Nama Petani" readonly>
                    </div>
                  @endif
                  <div class="col-lg-4 col-12 mb-3">
