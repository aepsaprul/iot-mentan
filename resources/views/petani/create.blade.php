@extends('layouts.app')
@section('title') Tambah Petani @endsection
@section('style')
@endsection
@section('content')
            ...
            <div class="card-body">
              <form action="{{ route('petani.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Nama Petani" required autofocus>
                    @error('nama')
